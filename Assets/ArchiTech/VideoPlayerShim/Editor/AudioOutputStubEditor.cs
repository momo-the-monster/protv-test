...
namespace VRCVideoPlayerShim
{
    ...
    [CustomEditor(typeof(AudioOutputStub))]
    public class AudioOutputStubEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if ((AudioOutputStub.AudioOutputMode)_propAudioOutputMode.enumValueIndex == AudioOutputStub.AudioOutputMode.MultipleChannels)
            {
            ...
            AudioOutputStub audioOutput = (AudioOutputStub)this.target;
            if (audioOutput != null)
            {
                if (audioOutput.Player != null && audioOutput.Player.Control != null)
                {
                    ...
                    if (channelCount >= 0)
                    {
                        ...
                        GUILayout.Label(audioChannels.ToString(), new GUIStyle(EditorStyles.textArea) { wordWrap = true });
